DEV_SERVER_LOCATION = "https://remote-settings-dev.allizom.org/v1"
STAGE_SERVER_LOCATION = "https://remote-settings.allizom.org/v1"
PROD_SERVER_LOCATION = "https://remote-settings.mozilla.org/v1"
